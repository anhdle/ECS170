...
public class FaceDetection_997995396_998513706 {
    ...
    public static void main (String [] args) throws IOException {
        ...
        System.out.println( "I was getting denied permission to ~davidson/ so I just made the convention of placing the "
                + "directories in the same folder as the script. "
                + "(i.e put males/ females/ test/ in the same folder as the .java file). "
                + "Also I disposed of the -test -train flags. By default it will train on males/ and females/"
                + "and then test on test/" );
