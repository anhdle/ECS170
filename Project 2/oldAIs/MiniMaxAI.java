...
//    private int[] branchOrdering = {0, 1, 2, 3, 4, 5, 6};
    ...
    public void getNextMove(final GameStateModule game) {
        ...
        System.out.println( "\n===== Nash: " + miniMax(game, ET_Current, 0, 1) + " =====\n" );
    ...
    private int miniMax(final GameStateModule game, EvaluationTable ET, int depth, int playerIndex){
        ...
        if(playerIndex ==  1){ // Max player
            ...
            for(int i : branchOrdering )
                if(game.canMakeMove (i))
                {
                    ...
                    int v = miniMax(game, ET_Copy, depth, 2);
                    if (max < v){
                        max = v;
                        if( depth == 1 )
                            maxMove = i;
            ...
            for(int i : branchOrdering)
                if(game.canMakeMove (i)) 
                {
                    ...
                    int v = miniMax(game, ET_Copy, depth, 1);
                    if (min > v){
                            min = v;
                    }
                    game.unMakeMove();
    ...
    public class EvaluationTable {
        ...
        public void move(int col, int player) {
            ...
            if(col > 7 || col < 1 || row > 6 || row < 1) {
                System.out.println("Out of bounds c:" + col + " r:" + row);
            }
